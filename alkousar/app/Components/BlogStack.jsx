...
// (manual scroll listener + getBoundingClientRect), generalized to however
// many published posts come back from Supabase.
//
// Desktop: cards scale down and rotate slightly (alternating direction) as
// the next card scrolls over them — the original "twist" look.
// Mobile: cards just scale down flat, no rotation, so they read as a clean
// stack sitting directly on top of one another.
