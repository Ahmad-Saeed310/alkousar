...
useGSAP(() => {
  ...
  return (
    <div className="w-full h-[10vh] fixed flex items-center justify-between p-[5vh] elems z-50 ">
      <Image
        src="/logoBlack.png"
        width={100}
        height={100}
      ...
      <div className="elems flex items-center gap-[5vw] uppercase text-sm text-black">
        <Link
          href="/about"
