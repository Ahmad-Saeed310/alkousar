...
export default function MapJourney() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const pov = document.querySelector(".pov") as SVGGElement;

      const povInner = document.querySelector(".pov-inner") as SVGGElement;
        ...
        >
          <g className="pov">
            <g className="pov-inner">
              <image href="/Map2.svg" width="1500" height="1500" />
...
"
              ...
              <circle className="dot-end" r="10" fill="#fff600" />
            </g>
          </g>
        </svg>
      </section>
