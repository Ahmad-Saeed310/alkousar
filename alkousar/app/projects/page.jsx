        ...
        >
          {PROJECTS.map((p) => (
            ...
            >
              ...
              {/* Title — now OUTSIDE the image box, left-aligned, in normal document flow below it */}
            ...
            //     {p.tag}
            //   </span> */}
            //       <span className="text-[1.5vw] font-regular tracking-tight text-white leading-tight">
            //         {p.title}
            //       </span>
            //       <span className="mt-3 text-[1vw] text-white/60 flex items-center gap-1">
            //         View project <span className="text-base">↗</span>
            //       </span>
            //     </div>
            //     <span className="text-xl font-bold tracking-tight text-white leading-tight">
