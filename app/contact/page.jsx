  ...
  return (
    <>
      ...
      <section className="h-screen w-full relative bg-stone-100 overflow-hidden">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 md:grid-rows-2 h-full w-full gap-8 md:gap-[1vw] pt-[12vh] md:pt-0">
          <Nav />

          {/* Top Left */}
          <div className="flex flex-col justify-center px-5 md:pl-[5vw]">
            <Animateword
              text="Contact Us"
              typess="page"
              classname="text-black/50 uppercase tracking-widest"
            ...
            <Chars
              type="heading"
              texts="Let's Talk"
              className="text-black text-[18vw] md:text-[6vw]"
            />
          </div>

          {/* Top Right */}
          <div className="px-5 md:relative">
            <div className="md:absolute md:bottom-[10vh] md:left-[5vw] md:right-[5vw]">
              <ScrollWords
                textss="Questions about a plot, a home, or an investment in DHA Bahawalpur? We're a call away."
                typess="subheading"
                className="text-black/70 text-[5vw] md:text-[2.2vw] leading-snug"
              />
            </div>
          </div>

          {/* Bottom Left */}
          <div className="px-5 md:pt-0 pt-[40vh] md:relative md:pl-[5vw]">
            <div className="flex flex-col gap-4 md:absolute md:bottom-[8vh]">
              <a
                href="tel:+923477246576"
                className="text-black text-[8vw] md:text-[2.4vw] font-medium hover:opacity-60 transition-opacity w-fit"
              >
                +92 347 7246576
              </a>
              ...
              <a
                href="mailto:alkousarproperties@gmail.com"
                className="text-black text-[4.5vw] md:text-[1.2vw] font-light hover:opacity-60 transition-opacity w-fit"
              >
                alkousarproperties@gmail.com
              </a>
            </div>
          ...
          {/* Bottom Right */}
          <div className="px-5 pb-10 md:relative md:pr-[5vw]">
            <div className="flex flex-col gap-3 md:absolute md:bottom-[8vh] md:right-[5vw] md:items-end md:text-right">
              <Texts
                type="page"
                texts="Office# 03, Alpha Avenue, Sector-B, DHA Bahawalpur"
                className="text-black/70 max-w-full md:max-w-[22vw]"
              />

              <span className="text-black/40 text-[4vw] md:text-[0.9vw] uppercase tracking-widest">
                Always Open
              </span>
            </div>
          </div>
