...
const rows = [
  { id: 1,  title: "Al-Kousar Properties", tag: "Real Estate",  img: "https://images.unsplash.com/photo-1613977257363-707ba9348227?w=800&q=80" },
  { id: 2,  title: "Arch Studio",          tag: "Architecture", img: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80" },
  { id: 3,  title: "Verde Living",         tag: "Interior",     img: "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80" },
  { id: 4,  title: "Noir Branding",        tag: "Branding",     img: "https://images.unsplash.com/photo-1634942537034-2531766767d1?w=800&q=80" },
    ...
    >
      ...
      <span className="relative z-10 flex items-center justify-between w-full">
        ...
        <span
          ...
          style={{ color: isActive ? "rgba(255,255,255,0.35)" : "rgba(0,0,0,0.3)" }}
        >
        ...
        <span
          ...
          style={{ color: isActive ? "rgba(255,255,255,0.45)" : "rgba(0,0,0,0.35)" }}
        >
          {row.tag}
        </span>
